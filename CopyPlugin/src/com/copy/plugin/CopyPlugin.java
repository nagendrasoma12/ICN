...
public class CopyPlugin extends Plugin {
	...
	public String getConfigurationDijitClass() {
		return "copyPluginDojo.ConfigurationPane";
	}
	...
	public com.ibm.ecm.extension.PluginAction[] getActions() {
		return new com.ibm.ecm.extension.PluginAction[]{new com.copy.plugin.actions.CopyAction()};
	}
	...
	public com.ibm.ecm.extension.PluginResponseFilter[] getResponseFilters() {
		return new com.ibm.ecm.extension.PluginResponseFilter[]{new com.copy.plugin.responseFilter.ActionsFilter()};
	}
